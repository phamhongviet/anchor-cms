...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="<?php echo theme_url('/css/small.css'); ?>" media="(max-width: 700px)">
		...
		<script async src="<?php echo asset_url('/js/zepto.js'); ?>"></script>
		<?php if (site_meta('show_tray') != "no"): ?>
		<script async src="<?php echo theme_url('/js/main.js'); ?>"></script>
		<?php endif; ?>
	...
	<body class="<?php echo body_class(); ?>">
		<div class="main-wrap">
			...
			<div class="slidey" id="tray">
				<div class="wrap">
					<?php if (site_meta('show_search') != "no"): ?>
					...
					<?php if (site_meta('show_categories') != "no"): ?>
					<aside>
						<b>Categories</b>
						<ul>
